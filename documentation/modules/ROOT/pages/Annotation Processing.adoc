...
The differences only start when extending`annotation_processing.api.com.derivandi.Ap.Processor` instead of `javax.annotation.processing.AbstractProcessor`.
...
import builder.com.derivandi.Customer;

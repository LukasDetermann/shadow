...
=== What is this?
[[Annotation Processing.What is this]]
...
[%linenums,java]
----
include::../test/java/io/determann/shadow/builder/ShadowBuilderProcessor.java[]
----

.For a simple pojo like
[%linenums,java]
----
include::../test/java/io/determann/shadow/builder/Customer.java[]
----

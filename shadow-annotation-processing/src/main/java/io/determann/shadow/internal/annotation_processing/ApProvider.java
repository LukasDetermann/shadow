      ...
      extends AbstractProvider
{
   ...
   {
      builder.withOptional(GET_PACKAGE_IN_MODULE, (implementation, moduleName, packageName) -> ((ApImplementation) implementation).getContext().getPackage(moduleName, packageName))
             .with(GET_PACKAGE, (implementation, name) -> ((ApImplementation) implementation).getContext().getPackage(name))
             .withOptional(GET_MODULE, (implementation, name) -> ((ApImplementation) implementation).getContext().getModule(name))
             .withOptional(GET_DECLARED, (implementation, name) -> ((ApImplementation) implementation).getContext().getDeclared(name))
             ...
             .with(GET_VOID, implementation -> ((ApImplementation) implementation).getContext().getConstants().getVoid())
             .with(GET_NULL, implementation -> ((ApImplementation) implementation).getContext().getConstants().getNull())
             .with(GET_BOOLEAN,implementation -> ((ApImplementation) implementation).getContext().getConstants().getPrimitiveBoolean())
             .with(GET_BYTE, implementation -> ((ApImplementation) implementation).getContext().getConstants().getPrimitiveByte())
             .with(GET_SHORT, implementation -> ((ApImplementation) implementation).getContext().getConstants().getPrimitiveShort())
             .with(GET_INT, implementation -> ((ApImplementation) implementation).getContext().getConstants().getPrimitiveInt())
             .with(GET_LONG, implementation -> ((ApImplementation) implementation).getContext().getConstants().getPrimitiveLong())
             .with(GET_CHAR, implementation -> ((ApImplementation) implementation).getContext().getConstants().getPrimitiveChar())
             .with(GET_FLOAT, implementation -> ((ApImplementation) implementation).getContext().getConstants().getPrimitiveFloat())
             .with(GET_DOUBLE, implementation -> ((ApImplementation) implementation).getContext().getConstants().getPrimitiveDouble())
             ...
             .withOptional(DECLARED_GET_SURROUNDING, declared -> query(declared).getSurrounding())
             .with(ENUM_GET_CONSTRUCTORS, anEnum -> query(anEnum).getConstructors())
             .with(ENUM_GET_ENUM_CONSTANT, (anEnum, s) -> query(anEnum).getEnumConstantOrThrow(s))
             .with(ENUM_GET_ENUM_CONSTANTS, anEnum -> query(anEnum).getEumConstants())
             .with(INTERFACE_IS_FUNCTIONAL, anInterface -> query(anInterface).isFunctional())
             .with(INTERFACE_GET_GENERIC_USAGES, anInterface -> query(anInterface).getGenericUsages())
             .with(INTERFACE_GET_GENERIC_DECLARATIONS, anInterface -> query(anInterface).getGenericDeclarations())
             .with(INTERFACE_GET_PERMITTED_SUB_TYPES, anInterface -> query(anInterface).getPermittedSubTypes())
             ...
             .with(RECORD_GET_CONSTRUCTORS, record -> query(record).getConstructors())
             .with(RECORD_GET_GENERIC_USAGES, record -> query(record).getGenericUsages())
             .with(RECORD_GET_GENERIC_DECLARATIONS, record -> query(record).getGenericDeclarations())
             .with(CLASS_GET_CONSTRUCTORS, aClass -> query(aClass).getConstructors())
             ...
             .with(CLASS_GET_GENERIC_USAGES, aClass -> query(aClass).getGenericUsages())
             .with(CLASS_GET_GENERIC_DECLARATIONS, aClass -> query(aClass).getGenericDeclarations())
             ...
             .with(EXECUTABLE_GET_GENERIC_DECLARATIONS, executable -> query(executable).getGenericDeclarations())
             ...
             .with(METHOD_GET_RETURN_TYPE, method -> query(method).getReturnType())
             ...
             .with(METHOD_GET_RESULT, executable -> query(executable).getResult())
             ...
             .with(GENERIC_GET_BOUND, cGeneric -> query(cGeneric).getBound())
             .with(GENERIC_GET_BOUNDS, cGeneric -> query(cGeneric).getBounds())

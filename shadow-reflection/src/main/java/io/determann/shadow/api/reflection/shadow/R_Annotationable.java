 ...
 */
public interface R_Annotationable extends C_Annotationable
{
   /**
    ...
    */
   List<R_AnnotationUsage> getAnnotationUsages();

   default List<R_AnnotationUsage> getUsagesOf(C_Annotation annotation)
   {
   ...
   default Optional<R_AnnotationUsage> getUsageOf(C_Annotation annotation)
   {
      List<R_AnnotationUsage> usages = getUsagesOf(annotation);
   ...
   default R_AnnotationUsage getUsageOfOrThrow(C_Annotation annotation)
   {
    ...
    */
   List<R_AnnotationUsage> getDirectAnnotationUsages();

   default List<R_AnnotationUsage> getDirectUsagesOf(C_Annotation annotation)
   {
   ...
   default Optional<R_AnnotationUsage> getDirectUsageOf(C_Annotation annotation)
   {
      return getDirectAnnotationUsages().stream()
                                        .filter(usage -> requestOrThrow(usage, ANNOTATION_USAGE_GET_ANNOTATION).equals(annotation))
                                        .findAny();
   ...
   default R_AnnotationUsage getDirectUsageOfOrThrow(C_Annotation annotation)
   {

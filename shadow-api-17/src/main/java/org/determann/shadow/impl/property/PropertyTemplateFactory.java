...
import static org.determann.shadow.api.TypeKind.CLASS;
import static org.determann.shadow.api.TypeKind.VOID;
import static org.determann.shadow.impl.property.PropertyTemplateFactory.AccessorType.GETTER;
import static org.determann.shadow.impl.property.PropertyTemplateFactory.AccessorType.SETTER;

class PropertyTemplateFactory
{
   private static record Accessor(Method method,
                                  AccessorType type,
                                  String prefix,
                                  String name,
                                  int position) {}

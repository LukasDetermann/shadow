...
abstract class VariableTest<SURROUNDING extends Shadow<? extends TypeMirror>, VARIABLE extends Variable<SURROUNDING>> extends ShadowTest<VARIABLE>
{
   ...
   void testGetPackage()
   {
      CompilationTest.process(shadowApi -> assertEquals(shadowApi.getPackages("org.determann.shadow.example.processed.test.field").get(0),
                     ...
                     .withCodeToCompile("FieldExample.java", """
                           package org.determann.shadow.example.processed.test.field;

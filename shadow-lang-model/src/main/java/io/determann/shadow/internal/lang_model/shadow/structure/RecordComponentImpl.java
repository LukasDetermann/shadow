...
public class RecordComponentImpl implements LM.RecordComponent
{
   private final RecordComponentElement recordComponentElement;
   private final LM.Context context;
   private final TypeMirror typeMirror;

   public RecordComponentImpl(LM.Context context, RecordComponentElement recordComponentElement)
   {
   ...
   {
      return adapt(getApi()).toTypes().isSubtype(getMirror(), adapt((LM.Type) type).toTypeMirror());
   }
   ...
   @Override
   public LM.Record getRecord()
   {
      return (LM.Record) adapt(getApi(), ((TypeElement) getElement().getEnclosingElement()));
   }
   ...
   {
      return (LM.Method) adapt(getApi(), getElement().getAccessor());
   }

...
public class ParameterImpl extends VariableImpl implements LM.Parameter
{
   public ParameterImpl(LM.Context context, VariableElement variableElement)
   {
   ...
   @Override
   public LM.Executable getSurrounding()
   {

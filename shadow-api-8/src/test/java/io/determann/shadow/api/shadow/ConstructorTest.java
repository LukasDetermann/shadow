...
class ConstructorTest extends ExecutableTest<Constructor>
{
   ...
   {
      ProcessorTest.process(shadowApi -> assertEquals(Collections.singletonList(shadowApi.getClassOrThrow("java.lang.Long")),
                                                      shadowApi.getClassOrThrow("ConstructorExample")
                                                               .getConstructors()
                                                               .get(0)
                                                               .getParameterTypes()))
      ...
      ProcessorTest.process(shadowApi ->
                            {
                               ...
                               assertEquals(Collections.singletonList(shadowApi.getClassOrThrow("java.io.IOException")),
                                            shadowApi.getClassOrThrow("ConstructorExample")
                                                     .getConstructors()
                                                     .get(1)
                                                     .getThrows());

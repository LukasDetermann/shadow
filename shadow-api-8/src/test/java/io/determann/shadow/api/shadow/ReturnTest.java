...
class ReturnTest
{
   ...
   void getType()
   {
      ProcessorTest.process(context ->
                   ...
                   .withCodeToCompile("ReturnExample.java", "abstract class ReturnExample {   public abstract Integer method();}")
                   .compile();
   }
   ...
   void getAnnotationUsages()
   {
      ProcessorTest.process(context ->
                   ...
                   .withCodeToCompile("ReturnExample.java", "abstract class ReturnExample {public abstract @MyAnnotation(2) Integer method();}")
                   .compile();
   }
}
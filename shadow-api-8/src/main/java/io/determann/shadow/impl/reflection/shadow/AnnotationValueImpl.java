...
public class AnnotationValueImpl implements AnnotationValue
{
   ...
   public List<AnnotationValue> asListOfValues()
   {
      ...
      {
         return stream((Object[]) value).map(o -> new AnnotationValueImpl(o, isDefaultValue()))
      ...
      {
         return stream((int[]) value).boxed()
                                     .map(o -> new AnnotationValueImpl(o, isDefaultValue()))
                                     .map(AnnotationValue.class::cast)
                                     .collect(collectingAndThen(toList(), Collections::unmodifiableList));
      }
      if (componentType.equals(long.class))
      {
         return stream((long[]) value).boxed()
                                      .map(o -> new AnnotationValueImpl(o, isDefaultValue()))
                                      .map(AnnotationValue.class::cast)
                                      .collect(collectingAndThen(toList(), Collections::unmodifiableList));
      }
      ...
      {
         return stream((double[]) value).boxed()
                                        .map(o -> new AnnotationValueImpl(o, isDefaultValue()))
                                        .map(AnnotationValue.class::cast)
                                        .collect(collectingAndThen(toList(), Collections::unmodifiableList));
      }

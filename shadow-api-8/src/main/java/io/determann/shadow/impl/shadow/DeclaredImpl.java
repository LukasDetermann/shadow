                                                                      ...
                                                                      Enum
{
   ...
   {
      return getApi().getJdkApiContext().processingEnv().getTypeUtils().isSubtype(getMirror(), shadow.getMirror());
   }
   ...
   {
      return getApi().getJdkApiContext().processingEnv().getElementUtils().getBinaryName(getElement()).toString();
   }

...
public class WildcardImpl implements Wildcard
{
   ...
   public Optional<Shadow> getExtends()
   {
      ...
      switch (upperBounds.length)
      {
         case 0:
            return Optional.empty();
         case 1:
            return Optional.of(ReflectionAdapter.getShadow(upperBounds[0]));
         default:
            return Optional.of(new IntersectionImpl(upperBounds));
      }
   }
   ...
   public Optional<Shadow> getSuper()
   {
      ...
      switch (lowerBounds.length)
      {
         ...
         case 1 : return Optional.of(ReflectionAdapter.getShadow(lowerBounds[0]));
         default : return Optional.of(new IntersectionImpl(lowerBounds));
      }
   }

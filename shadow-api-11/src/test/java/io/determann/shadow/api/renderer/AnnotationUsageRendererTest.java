...
class AnnotationUsageRendererTest
{
   ...
   void usage()
   {
      ConsistencyTest.compileTime(context -> context.getClassOrThrow("AnnotationUsageExample")
                     ...
                     .withCode("AnnotationUsageAnnotation.java", "import java.lang.annotation.ElementType;\n" +
                                                                 ...
                                                                 "}\n")
                     .withCode("AnnotationUsageExample.java", "@AnnotationUsageAnnotation\n" +
                     ...
                     .test(annotationUsage ->
                           {
                              assertEquals(
                                    ...
                                    render(RenderingContext.DEFAULT, annotationUsage).usage());
